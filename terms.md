...
By downloading or using SessionTracker ("the App"), you agree to be bound by these Terms of Service.

## Description of Service

SessionTracker is a personal tracking application that allows you to log and analyze your gambling session results. The App does not facilitate, enable, or simulate gambling in any way.

## Intended Use

This App is intended for:

- Personal record-keeping of gambling activities
- Bankroll management and tracking
- Analysis of gambling session history

This App is **not intended for**:

- Facilitating or encouraging gambling
- Use by individuals under 18 years of age
- Use in jurisdictions where gambling is prohibited
...
2. You are responsible for the accuracy of data you enter
3. You will comply with all applicable laws regarding gambling in your jurisdiction
4. You understand that gambling involves financial risk
...
To the maximum extent permitted by law, SessionTracker and its developers shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or other intangible losses resulting from your use of the App.

## Intellectual Property

The App and its original content, features, and functionality are owned by SessionTracker and are protected by international copyright, trademark, and other intellectual property laws.

## Changes to Terms

We reserve the right to modify these terms at any time. We will notify users of any material changes by updating the "Last Updated" date. Continued use of the App after changes constitutes acceptance of the new terms.

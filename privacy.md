...
- **Local Storage**: Session data you enter (locations, amounts, notes, etc.) is stored locally on your device using Apple's SwiftData framework.
- **iCloud Sync**: If enabled, your data syncs across your devices using your personal iCloud account. This data is encrypted and managed by Apple according to [Apple's Privacy Policy](https://www.apple.com/privacy/).
...
The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them via the [Support Page](support) and they will respond in a reasonable time.

### Your Data Rights

You have control over your data:

- **Access**: All your data is visible within the Application
- **Export**: You can export your sessions to CSV at any time
- **Deletion**: You can delete individual sessions or all data within the Application
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please visit our **[Support Page](support)**.
